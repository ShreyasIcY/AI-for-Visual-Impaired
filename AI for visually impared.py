...
GEMINI_API_KEY = "keys.txt"  # Replace with your valid API key
...
st.markdown('<div class="main-title">FocusAssist 👁️</div>', unsafe_allow_html=True)
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> | ©️  Shreyas  | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)